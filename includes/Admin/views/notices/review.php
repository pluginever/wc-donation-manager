...
<div class="notice-body">
	...
	<div class="notice-content">
		<h3><?php esc_html_e( 'Enjoying WC Donation Manager?', 'wc-donation-manager' ); ?></h3>
		<p>
			<?php
			echo wp_kses_post(
				sprintf(
				// translators: %1$s: WC Donation Manager WP ORG link, %2$s: Coupon code.
					...
					'<a href="ttps://wordpress.org/plugins/wc-donation-manager/" target="_blank"><strong>WC Donation Manager</strong></a>',
