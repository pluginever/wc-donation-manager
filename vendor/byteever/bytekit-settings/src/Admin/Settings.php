...
abstract class Settings
{
    ...
    protected function output_plugins_widget()
    {
        ...
        if (!empty($promo_plugins)) {
            ...
            foreach ($promo_plugins as $promo_plugin) {
                $promo_plugin = wp_parse_args($promo_plugin, array('name' => '', 'description' => '', 'basename' => '', 'slug' => '', 'badge' => esc_html__('Recommended', 'wc-donation-manager'), 'button' => esc_html__('Install Now', 'wc-donation-manager'), 'installed' => false));
    ...
    protected function output_support_widget()
    {
        ...
        if (!empty($support_links)) {
			...
			<div class="bk-card">
				<div class="bk-card__header">
					<?php 
            esc_html_e('Need Help?', 'wc-donation-manager');
            ?>
				</div>
				<div class="bk-card__body">
					<ul>
    ...
    {
        return array(array('name' => 'WC Min Max Quantities', 'slug' => 'wc-min-max-quantities', 'description' => 'Set minimum and maximum price or quantity for WooCommerce products.', 'link' => 'https://wordpress.org/plugins/wc-min-max-quantities/', 'badge' => esc_html__('Recommended', 'wc-donation-manager'), 'button' => esc_html__('Install Now', 'wc-donation-manager')));
    }
    /**
     * Get support links.
     *
    ...
    {
        return array('facebook' => array('label' => __('Join our Community', 'wc-donation-manager'), 'url' => 'https://www.facebook.com/groups/pluginever'), 'feature-request' => array('label' => __('Request a Feature', 'wc-donation-manager'), 'url' => 'https://www.pluginever.com/contact/'), 'bug-report' => array('label' => __('Report a Bug', 'wc-donation-manager'), 'url' => 'https://www.pluginever.com/contact/'));
    }
    /**
     * Get current page.
     *
